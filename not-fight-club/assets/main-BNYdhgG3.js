(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(){document.querySelector(`#app`).innerHTML=`
    ...
    `}function t(e,t){e.addEventListener(`input`,n=>{e.value===``?t.classList.add(`create__character-btn-none`):t.classList.remove(`create__character-btn-none`)})}function n(){}function r(r,i){let o=`${i} ${r}`,s=`${i}`;document.querySelector(`#app`).innerHTML=`
    <header class="header">
  ...
  `,document.querySelector(`.main__restart`).addEventListener(`click`,()=>{e(),t(document.querySelector(`.create__character-input`),document.querySelector(`.create__character-btn`)),a(document.querySelector(`.create__character-btn`))}),document.querySelector(`.main__sanitarium`).addEventListener(`click`,n),document.querySelector(`.main__tavern`).addEventListener(`click`,n),localStorage.setItem(`fullName`,o),localStorage.setItem(`name`,r),localStorage.setItem(`character`,s)}var i=new class{constructor(e){this.audio=new Audio(e),this.audio.volume=.5}play(){this.audio.play()}stop(){this.audio.pause()}}(`./assets/audio/btnClick.mp3`);function a(e){e.addEventListener(`click`,t=>{let n=document.querySelector(`.create__character-input`).value;n.trim()===``?e.classList.add(`create__character-btn-none`):(document.querySelector(`#app`).innerHTML=`
      <div class="container">
        <header class="header">
      ...
      `,localStorage.setItem(`fullName`,n),i.play(),document.querySelector(`.character__container`).addEventListener(`click`,e=>{let t=e.target.closest(`.character__hero-card`);t&&(r(n,t.id),i.play())}))})}new class{constructor(e){this.audio=new Audio(e),this.audio.volume=.2,this.audio.loop=!0}play(){this.audio.play()}stop(){this.audio.pause()}}(`./assets/audio/hamlet.mp3`),new class{constructor(e){this.audio=new Audio(e),this.audio.volume=.2,this.audio.loop=!0}play(){this.audio.play()}stop(){this.audio.pause()}}(`./assets/audio/battle_sound.mp3`);function o(e,t,n){e.addEventListener(`click`,()=>(document.querySelector(`#app`).innerHTML=`
      <header class="header">
    ...
    `,2))}var s=new class{constructor(e){this.audio=new Audio(e),this.audio.volume=.5}play(){this.audio.play()}stop(){this.audio.pause()}}(`./assets/audio/welcome.mp3`);function c(n,c){document.querySelector(`#app`).innerHTML=`
    <main class="main__welcome" id="main">
      <div class="welcome__window">
        ...
        <div class="welcome__last">
          ...
          <h3 class="welcome__last-character">Your last character: <span>${c}</span></h3>
        </div>
  ...
  `,document.querySelector(`#restart__btn`).addEventListener(`click`,()=>{e(),t(document.querySelector(`.create__character-input`),document.querySelector(`.create__character-btn`)),a(document.querySelector(`.create__character-btn`)),i.play()}),document.querySelector(`#continue__btn`).addEventListener(`click`,()=>{n!==null&&c!==null&&(r(n,c),o(document.querySelector(`.main__start-arrow`),localStorage.getItem(`name`),localStorage.getItem(`character`)),i.play(),s.play())})}document.querySelector(`#app`).innerHTML=`
<header class="header">
  <h1 class="header__title">Not fight club</h1>
</header>
<main id="main">
</main>
`,localStorage.getItem(`fullName`)!==null&&localStorage.getItem(`character`)!==null?c(localStorage.getItem(`name`),localStorage.getItem(`character`)):(e(),t(document.querySelector(`.create__character-input`),document.querySelector(`.create__character-btn`)),a(document.querySelector(`.create__character-btn`)));